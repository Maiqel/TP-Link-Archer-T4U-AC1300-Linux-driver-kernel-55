...
#ifndef PLATFORM_FREEBSD
/* compress 512-bits */
static int sha256_compress(struct TPLink_sha256_state *md, unsigned char *buf)
{
	u32 S[8], W[64], t0, t1;
	u32 t;
	int i;
...
static void TPLink_sha256_init(struct TPLink_sha256_state *md)
{
	md->curlen = 0;
	md->length = 0;
...
*/
static int sha256_process(struct TPLink_sha256_state *md, unsigned char *in,
			  unsigned long inlen)
{
	unsigned long n;
...
/**
   ...
   @return CRYPT_OK if successful
*/
static int sha256_done(struct TPLink_sha256_state *md, unsigned char *out)
{
	int i;
...
static int sha256_vector(size_t num_elem, u8 *addr[], size_t *len,
			 u8 *mac)
{
	struct TPLink_sha256_state ctx;
	size_t i;

	TPLink_sha256_init(&ctx);
